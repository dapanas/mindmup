...
if(a&&a.gesture&&a.gesture.scale){a.preventDefault(),a.gesture.preventDefault();var c=a.gesture.scale;m&&(c/=m),Math.abs(c-1)<.05||(m=a.gesture.scale,b.scale("touch",c,{x:a.gesture.center.pageX-l.data("offsetX"),y:a.gesture.center.pageY-l.data("offsetY")}))}}).on("gestureend",function(){m=!1}):(a.scrollWhenDragging(b.getInputEnabled),a.on("mousedown",function(b){b.target!==a[0]&&a.css("overflow","hidden")}),jQuery(document).on("mouseup",function(){"auto"!==a.css("overflow")&&a.css("overflow","auto")}),a.imageDropWidget(d)),MAPJS.DOMRender.viewController(b,l,c,d,f,h),_.each(i,function(c,d){a.keydown(d,function(a){k&&(a.stopImmediatePropagation(),a.preventDefault(),b[c]("keyboard"))})}),c||jQuery(window).on("resize",function(){b.resetView()}),jQuery(window).on("orientationchange",function(){g?b.centerOnNode(b.getSelectedNodeId()):b.resetView()}),jQuery(document).on("keydown",function(a){var c,d={"U+003D":"scaleUp","U+002D":"scaleDown",61:"scaleUp",173:"scaleDown"};a&&!a.altKey&&(a.ctrlKey||a.metaKey)&&(a.originalEvent&&a.originalEvent.keyIdentifier?c=d[a.originalEvent.keyIdentifier]:"MozPrintableKey"===a.key&&(c=d[a.which]),c&&k&&(a.preventDefault(),b[c]("keyboard")))}).on("wheel mousewheel",function(b){var c=b.originalEvent.deltaX||-1*b.originalEvent.wheelDeltaX;0>c&&0===a.scrollLeft()&&b.preventDefault(),c>0&&a[0].scrollWidth-a.width()-a.scrollLeft()===0&&b.preventDefault()}),a.on("keypress",function(a){if(k&&!/INPUT|TEXTAREA/.test(a&&a.target&&a.target.tagName)){var c=a.charCode||a.keyCode,d=String.fromCharCode(c),e=j[d];e?(a.preventDefault(),b[e]("keyboard")):Number(d)<=9&&Number(d)>=1&&(a.preventDefault(),b.activateLevel("keyboard",Number(d)+1))}})})};var MM=MM||{};MM.IOS=MM.IOS||{},MM.ActivityLog=function(a){"use strict";var b=[],c=1,d=this;observable(this),this.log=function(){var e=["log"];b.length===a&&b.shift(),b.push({id:c,ts:new Date,event:Array.prototype.join.call(arguments,",")}),c+=1,Array.prototype.slice.call(arguments).forEach(function(a){jQuery.isArray(a)?e=e.concat(a):e.push(a)}),d.dispatchEvent.apply(d,e)},this.error=function(a){d.log("Error",a),d.dispatchEvent("error",a,b)},this.getLog=b.slice.bind(b),this.timer=function(a,b){var c=Date.now();return{end:function(){d.dispatchEvent("timer",a,b,Date.now()-c)}}}},jQuery.fn.trackingWidget=function(a){"use strict";return this.each(function(){var b=jQuery(this),c=b.data("category"),d=b.data("event-type")||"",e=b.data("label")||"";b.click(function(){a.log(c,d,e)})})},MM.iconEditor=function(a,b){"use strict";observable(this);var c,d=this;this.editIcon=function(a){return a&&(a.url=b.getResource(a.url)),c=jQuery.Deferred(),this.dispatchEvent("iconEditRequested",a),c.promise()},this.save=function(a){c.resolve(a)},this.cancel=function(){c.reject()},a.addEventListener("nodeIconEditRequested",function(){var c=a.getIcon();d.editIcon(c).then(function(c){c?a.setIcon("icon-editor",b.storeResource(c.url),c.width,c.height,c.position):a.setIcon(!1)})})},jQuery.fn.iconEditorWidget=function(a,b){"use strict";var c=this,d=c.find("[data-mm-role~=confirm]"),e=c.find("form select[name=size]"),f=c.find("[data-mm-role=custom-size-enter]"),g=c.find("[data-mm-role=img-preview]"),h=c.find("[data-mm-role~=clear]"),i=c.find("select[name=position]"),j=c.find("input[name=width]"),k=c.find("input[name=height]"),l=c.find("input[name=keepratio]"),m=c.find("input[name=selectfile]"),n=c.find("[data-mm-role=drop-zone]"),o=c.find("[data-mm-role=select-file]"),p=function(){a.save({url:g.attr("src"),width:Math.round(j.val()),height:Math.round(k.val()),position:i.val()})},q=function(){a.save(!1)},r=function(a){a?(g.show(),g.attr("src",a.url),c.find("[data-mm-role=attribs]").show(),i.val(a.position),j.val(a.width),k.val(a.height),m.val(""),h.show(),d.show()):(g.hide(),c.find("[data-mm-role=attribs]").hide(),h.hide(),d.hide())},s=function(){m.click()},t=new MAPJS.ImageInsertController(b);return o.click(s).keydown("space enter",s),t.addEventListener("imageInserted",function(a,b,e){g.attr("src",a),j.val(b),k.val(e),c.find("[data-mm-role=attribs]").show(),g.show(),d.show(),d.focus()}),n.imageDropWidget(t),j.on("change",function(){l[0].checked&&k.val(Math.round(g.height()*parseInt(j.val(),10)/g.width()))}),k.on("change",function(){l[0].checked&&j.val(Math.round(g.width()*parseInt(k.val(),10)/g.height()))}),m.on("change",function(a){t.insertFiles(this.files,a)}),c.modal({keyboard:!0,show:!1}),d.click(function(){p()}).keydown("space",function(){p(),c.modal("hide")}),h.click(function(){q()}).keydown("space",function(){q(),c.modal("hide")}),e.on("change",function(){"custom"===e.val()?f.show():f.hide()}),this.on("show",function(){m.css("opacity",0).val("")}),this.on("shown",function(){m.css("opacity",0).css("position","absolute").offset(n.offset()).width(n.outerWidth()).height(n.outerHeight()),o.focus()}),a.addEventListener("iconEditRequested",function(a){r(a),c.modal("show")}),this},MM.ActiveContentResourceManager=function(a,b){"use strict";var c=this,d=b+":",e=new RegExp("^"+d);c.storeResource=function(b){return d+a.getActiveContent().storeResource(b)},c.getResource=function(b){return e.test(b)?a.getActiveContent().getResource(b.substring(d.length)):b}},MM.ActiveContentListener=function(a){"use strict";var b,c=observable(this),d=function(a,d){c.dispatchEvent("mm-active-content-changed",b,!1,a,d)},e=function(a,e){b&&b.removeEventListener("changed",d),b=e,c.dispatchEvent("mm-active-content-changed",b,!0),b.addEventListener("changed",d)};a.addEventListener("mapLoaded",e,999),c.getActiveContent=function(){return b},c.addListener=function(a){b&&a(b,!1),c.addEventListener("mm-active-content-changed",a)}},jQuery.fn.atlasPrepopulationWidget=function(a,b,c,d,e){"use strict";d=d||MM.AtlasUtil.truncate,e=e||MM.AtlasUtil.sanitize;var f=this,g=function(){var g=f.find("form[data-mm-role~=atlas-metadata]"),h=a.getActiveContent(),i=h&&h.title,j=d(i,b),k=d("MindMup mind map: "+i,c),l=e(d(i,b));g.find("[name=title]").attr("placeholder",j).val(j),g.find("[name=description]").attr("placeholder",k).val(k),g.find("[name=slug]").attr("placeholder",l).val(l)};return f.on("show",function(a){this===a.target&&g()}),f},MM.AtlasUtil={truncate:function(a,b){"use strict";return a.substring(0,b)},sanitize:function(a){"use strict";var b=a.substr(0,100).toLowerCase().replace(/[^a-z0-9]+/g,"_");return"_"===b?"map":b}},MM.ResourceCompressor=function(a){"use strict";var b=this,c=a+":",d=new RegExp("^"+c),e=function(a){if(a.resources){var b={};_.map(a.resources,function(a,c){b[c]=!0}),a.traverse(function(a){var d=a&&a.attr&&a.attr.icon&&a.attr.icon.url;d&&delete b[d.substring(c.length)]}),_.each(b,function(b,c){delete a.resources[c]})}},f=function(a){a.traverse(function(b){var e=b&&b.attr&&b.attr.icon&&b.attr.icon.url;e&&!d.test(e)&&(b.attr.icon.url=c+a.storeResource(e))})};b.compress=function(a){f(a),e(a)}},MM.MapController=function(a){"use strict";observable(this);var b,c,d,e=this,f=this.dispatchEvent,g={},h=[].concat(a),i=function(a){var b;for(b=0;b<h.length;b++)if(h[b].recognises(a))return h[b]},j=function(a,c,e){d=e,b=!1,e=e||{},e.autoSave||a.addEventListener("changed",function(){b=!0}),g={idea:a,mapId:e.editable&&c},f("mapLoaded",c,a,e)};e.addMapSource=function(a){h.push(a)},e.validMapSourcePrefixesForSaving="abgp",e.setMap=j,e.isMapLoadingConfirmationRequired=function(){return b},e.currentMapId=function(){return g&&g.mapId},e.loadMap=function(a,d){var g=function(b){var c=b&&b.loaded||0,d=b&&b.total||1,e=b&&b.loaded?Math.round(100*c/d)+"%":b;f("mapLoading",a,e)},h=function(b,i){var k=function(){f("mapLoading",a),c.loadMap(a,!0).then(j,h,g)},l=c.description?" ["+c.description+"]":"";"no-access-allowed"===b?f("mapLoadingUnAuthorized",a,b):"failed-authentication"===b?f("authorisationFailed",c.description,k):"not-authenticated"===b?f("authRequired",c.description,k):"map-load-redirect"===b?e.loadMap(i,d):"user-cancel"===b?f("mapLoadingCancelled"):(i=i?i+l:l,f("mapLoadingFailed",a,b,i))};return a!==this.currentMapId()||d?!d&&b?void f("mapLoadingConfirmationRequired",a):(c=i(a))?(f("mapLoading",a),void c.loadMap(a).then(j,h,g)):void f("mapIdNotRecognised",a):void f("mapLoadingCancelled",a)},this.publishMap=function(a,h){var j=function(a,c){var h=d&&d.reloadOnSave;c=c||{},d=c,b=!1,g.mapId=a,f("mapSaved",a,g.idea,c),(h||c.reloadOnSave)&&e.loadMap(a,!0)},k=function(a){var b=a&&a.loaded||0,d=a&&a.total||1,e=a&&a.loaded?Math.round(100*b/d)+"%":a;f("mapSaving",c.description,e)},l=function(a,b){var d=function(){f("mapSaving",c.description),c.saveMap(g.idea,g.mapId,!0).then(j,l,k)},e=c.description||"";b=b?b+e:e,"no-access-allowed"===a?f("mapSavingUnAuthorized",function(){f("mapSaving",c.description,"Creating a new file"),c.saveMap(g.idea,"new",!0).then(j,l,k)}):"failed-authentication"===a?f("authorisationFailed",b,d):"not-authenticated"===a?f("authRequired",b,d):"file-too-large"===a?f("mapSavingTooLarge",c.description):"user-cancel"===a?f("mapSavingCancelled"):f("mapSavingFailed",a,b)},m=h?"":g.mapId;c=i(a||g.mapId),f("mapSaving",c.description),c.saveMap(g.idea,m).then(j,l,k)}},MM.MapController.activityTracking=function(a,b){"use strict";var c,d,e=function(a){return 1===a.id},f=function(a){return a.title&&-1===a.title.search(/MindMup|Lancelot|cunning|brilliant|Press Space|famous|Luke|daddy/)},g=function(a){return!f(a)},h=function(a){return e(a)&&a.find(f).length>5&&a.find(g).length<3},i=!1;a.addEventListener("mapLoaded",function(a,e){b.log("Map","View",a),c=h(e),d!==e&&(d=e,e.addEventListener("changed",function(a,c){i||(i=!0,b.log("Map","Edit")),b.log(["Map",a].concat(c))}))}),a.addEventListener("mapLoadingFailed",function(a,c,d){var e="Error loading map document ["+a+"] "+JSON.stringify(c);d&&(e=e+" label ["+d+"]"),b.error(e)}),a.addEventListener("mapSaving",b.log.bind(b,"Map","Save Attempted")),a.addEventListener("mapSaved",function(a,d){i=!1,h(d)&&!c?b.log("Map","Created Relevant",a):c?b.log("Map","Saved Relevant",a):b.log("Map","Saved Irrelevant",a)}),a.addEventListener("mapSavingFailed",function(a,c){b.error("Map save failed ("+c+")"+JSON.stringify(a))}),a.addEventListener("networkError",function(a){b.log("Map","networkError",JSON.stringify(a))})},MM.MapController.alerts=function(a,b,c){"use strict";var d,e=function(a,e,f,g){b.hide(d),c.showModalToConfirm("Please confirm",a,e).then(f,g)},f=function(a,c){b.hide(d),d=b.show(a,c,"error")};a.addEventListener("mapLoadingConfirmationRequired",function(b){var c=/^new/.test(b);e("There are unsaved changes in the current map. Please confirm that you would like to "+(c?"create a new map":"load a different map."),c?"Create New":"Load anyway",function(){a.loadMap(b,!0)})}),a.addEventListener("mapLoading",function(a,c){b.hide(d),d=b.show('<i class="icon-spinner icon-spin"></i>&nbsp;Please wait, loading the map...',c||"")}),a.addEventListener("mapSaving",function(a,c){b.hide(d),d=b.show('<i class="icon-spinner icon-spin"></i>&nbsp;Please wait, saving the map...',c||"")}),a.addEventListener("authRequired",function(a,b){e("This operation requires authentication through "+a+', an external storage provider. Please click on Authenticate below to go to the external provider and allow MindMup to access your account. You can learn more about authentication requirements on our <a href="http://blog.mindmup.com/p/storage-options.html" target="_blank">Storage Options</a> page.',"Authenticate",b)}),a.addEventListener("mapSaved mapLoaded",function(){b.hide(d)}),a.addEventListener("authorisationFailed",function(a,b){e("The operation was rejected by "+a+" storage. Click on Reauthenticate to try using different credentials or license.","Reauthenticate",b)}),a.addEventListener("mapLoadingUnAuthorized",function(){f("The map could not be loaded.",'You do not have the right to view this map. <a target="_blank" href="http://blog.mindmup.com/p/how-to-resolve-common-networking.html">Click here for some common solutions</a>')}),a.addEventListener("mapSavingUnAuthorized",function(a){e("You do not have the right to edit this map","Save a copy",a)}),a.addEventListener("mapLoadingFailed",function(a,b,c){f("Unfortunately, there was a problem loading the map."+c,'If you are not experiencing network problems, <a href="http://blog.mindmup.com/p/how-to-resolve-common-networking.html" target="blank">click here for some common ways to fix this</a>')}),a.addEventListener("mapSavingCancelled mapLoadingCancelled",function(){b.hide(d)}),a.addEventListener("mapSavingTooLarge",function(b){"S3_CORS"===b?e('The map is too large for anonymous MindMup storage. Maps larger than 100 KB can only be stored to MindMup Gold, or a third-party cloud storage. (<a href="http://blog.mindmup.com/p/storage-options.html" target="_blank">more info on storage options</a>)',"Save to MindMup Gold",function(){a.publishMap("b")},function(){a.dispatchEvent("mapSavingCancelled")}):f("Unfortunately, the file is too large for the selected storage.","Please select a different storage provider from File -&gt; Save As menu")}),a.addEventListener("mapSavingFailed",function(a,b,c){var d={"network-error":["There was a network problem communicating with the server.",'If you are not experiencing network problems, <a href="http://blog.mindmup.com/p/how-to-resolve-common-networking.html" target="blank">click here for some common ways to fix this</a>. Don\'t worry, you have an auto-saved version in this browser profile that will be loaded the next time you open the map']},g=d[a]||["Unfortunately, there was a problem saving the map.","Please try again later. We have sent an error report and we will look into this as soon as possible"];c?e(g[0],g[1],c):f(g[0],g[1])})},function(){"use strict";var a=jQuery.ajaxSettings.xhr.bind(jQuery.ajaxSettings);jQuery.ajaxSettings.xhr=function(){var b=a();return b instanceof XMLHttpRequest&&b.addEventListener("progress",this.progress,!1),b.upload&&b.upload.addEventListener("progress",this.progress,!1),b}}(),MM.AutoSave=function(a,b,c,d,e){"use strict";var f,g,h,i,j,k="auto-save-",l=this,m=[],n=function(a){var c=b.getItem(k+a);c&&l.dispatchEvent("unsavedChangesAvailable",a)},o=function(a,d){var f=k+d,g=function(){try{return b.setItem(f,m),!0}catch(a){return!1}},h=function(){j||(j=c.show("Unable to back up unsaved changes!","Please save this map as soon as possible to avoid losing unsaved information.","warning"))};m.push(a),g()||(b.removeKeysWithPrefix(k)+b.removeKeysWithPrefix(e)===0?h():g()||h())},p=function(a,b){m=[],h=function(a,c){o({cmd:a,args:c},b)},i=function(a,c){o({cmd:"storeResource",args:[a,c]},b)},a.addEventListener("changed",h),a.addEventListener("resourceStored",i)},q=function(){j&&c.hide(j),j=void 0},r=function(a,b,c){h&&g&&(g.removeEventListener("changed",h),g.removeEventListener("resourceStored",i)),!a||c&&c.autoSave||(f=a,g=b,q(),n(a),p(b,a))};observable(this),e=e||"clipboard",l.applyUnsavedChanges=function(){var a=b.getItem(k+f);a&&(d.pause(),a.forEach(function(a){g.execCommand(a.cmd,a.args)}),d.resume())},l.discardUnsavedChanges=function(){m=[],b.remove(k+f)},a.addEventListener("mapSaved",function(a,b){q(),(a===f||b===g)&&l.discardUnsavedChanges(),a!==f&&r(a,b)}),a.addEventListener("mapLoaded",r)},MM.JsonStorage=function(a){"use strict";var b=this;b.setItem=function(b,c){return a.setItem(b,JSON.stringify(c))},b.getItem=function(b){var c=a.getItem(b);try{return JSON.parse(c)}catch(d){}},b.remove=function(b){a.removeItem(b)},b.removeKeysWithPrefix=function(b){if(_.isEmpty(b))return 0;var c=Object.keys(a),d=_.filter(c,function(a){return 0===a.indexOf(b)});return _.each(d,function(b){a.removeItem(b)}),d.length}},MM.GoldApi=function(a,b,c,d){"use strict";var e,f,g=this,h="GoldApi",i=function(a){var b=["not-authenticated","invalid-args","server-error","user-exists","email-exists"];return _.contains(b,a)?a:a&&0===a.indexOf("not-connected ")?a:"network-error"},j=function(b,c,d,e){var f=jQuery.Deferred(),h=function(a){var c=_.extend({},d,{license:JSON.stringify(a)});e&&e!==a.account?f.reject("not-authenticated"):g.exec(b,c).then(function(b){f.resolve(b,a.account)},f.reject)};return a.retrieveLicense(c).then(h,f.reject),f.promise()};g.exec=function(a,d){var e=jQuery.Deferred(),f=function(b){var d=b.responseText;c.log(h,"error",a+":"+d),e.reject(i(d))},g=c.timer(h,a),j=new FormData,k={"license/register":"json","file/export_config":"json","file/upload_config":"json","file/echo_config":"json","license/subscription":"json","license/request_license_using_code":"json","license/request_license_using_google":"json"};return j.append("api_version","3"),d&&_.each(d,function(a,b){j.append(b,a)}),jQuery.ajax({url:b+"/"+a,dataType:k[a],data:j,processData:!1,contentType:!1,type:"POST"}).then(e.resolve,f).always(g.end),e.promise()},g.register=function(b,c){var d=jQuery.Deferred();return g.exec("license/register",{to_email:c,account_name:b}).then(function(b){b.license&&a.storeLicense(b.license),d.resolve(b)},d.reject,d.notify),d.promise()},g.getSubscription=function(){var b=a.getLicense();return g.exec("license/subscription",{license:JSON.stringify(b)})},g.cancelSubscription=function(){var b=a.getLicense();return g.exec("license/cancel_subscription",{license:JSON.stringify(b)})},g.generateExportConfiguration=function(b){var c=a.getLicense();return g.exec("file/export_config",{license:JSON.stringify(c),format:b})},g.generateEchoConfiguration=function(b,c){var d=a.getLicense();return g.exec("file/echo_config",{license:JSON.stringify(d),format:b,contenttype:c})},g.requestCode=function(a){return e=MM.onetimePassword(),f=a,g.exec("license/request_code",{identifier:a,one_time_pw:e})},g.restoreLicenseWithCode=function(b){var c=jQuery.Deferred();return e&&f?g.exec("license/request_license_using_code",{identifier:f,one_time_pw:e,code:b}).then(function(b){a.storeLicense(b),c.resolve()},c.reject):c.reject("no-code-requested"),c.promise()},g.restoreLicenseWithGoogle=function(b){var c=jQuery.Deferred();return g.exec("license/request_license_using_google",{token:b}).then(function(b){a.storeLicense(b),c.resolve()},c.reject),c.promise()},g.listFiles=function(a){var b=jQuery.Deferred(),c=function(a,c){var d=jQuery(a),e=[];d.find("Contents").each(function(){var a=jQuery(this),b=a.children("Key").text(),c=b.indexOf("/")+1;e.push({modifiedDate:a.children("LastModified").text(),title:b.slice(c)})}),b.resolve(e,c)};return j("file/list",a).then(c,b.reject),b.promise()},g.generateSaveConfig=function(a){return j("file/upload_config",a)},g.fileUrl=function(a,b,c,e){return e?j("file/url",a,{file_key:encodeURIComponent(c)},b):jQuery.Deferred().resolve("https://"+d+".s3.amazonaws.com/"+b+"/"+encodeURIComponent(c)).promise()},g.exists=function(b){var c=jQuery.Deferred(),d=a.getLicense();return d?g.exec("file/exists",{license:JSON.stringify(d),file_key:encodeURIComponent(b)}).then(function(a){var b=jQuery(a);c.resolve(b.find("Contents").length>0)},c.reject):c.reject("not-authenticated"),c.promise()},g.deleteFile=function(b){var c=jQuery.Deferred(),d=a.getLicense();return d?g.exec("file/delete",{license:JSON.stringify(d),file_key:b}).then(c.resolve,c.reject):c.reject("not-authenticated"),c.promise()}},MM.onetimePassword=function(){"use strict";var a=function(){var a=1+Math.random();return(65536*a||0).toString(16).substring(1)};return a()+"-"+a()},MM.GoldLicenseManager=function(a,b){"use strict";var c,d=this,e=function(a){return a&&"mindmup-gold"===a.accountType};observable(this),this.getLicense=function(){return a.getItem(b)},this.retrieveLicense=function(a){return c=void 0,!a&&this.getLicense()?jQuery.Deferred().resolve(this.getLicense()).promise():(c=jQuery.Deferred(),d.dispatchEvent("license-entry-required"),c.promise())},this.storeLicense=function(c){var d=c;if(_.isString(c))try{d=JSON.parse(c)}catch(f){return!1}return e(d)?(a.setItem(b,d),!0):!1},this.removeLicense=function(){a.setItem(b,void 0)},this.cancelLicenseEntry=function(){var a=c;c&&(c=void 0,a.reject("user-cancel"))},this.completeLicenseEntry=function(){var a=c;c&&(c=void 0,a.resolve(d.getLicense()))}},MM.LayoutExportController=function(a,b,c,d){"use strict";var e=this,f="Map",g=function(a){return a?a.toUpperCase()+" Export":"Export"},h=function(b){return a[b].exporter||a[b]},i=function(b,c,d){var e={"output-url":c};return a[b].processor?a[b].processor(_.extend(e,d)):jQuery.Deferred().resolve(e).promise()};e.startExport=function(a,e){var j=jQuery.Deferred(),k=g(a),l=function(){return"pending"!==j.state()},m=function(a,b){d.log(f,k+" failed",a),j.reject(a,b)},n=function(a){j.notify("Uploading "+(a||""))},o=h(a)(),p=_.extend({},o,e);return _.isEmpty(o)?j.reject("empty").promise():(d.log(f,k+" started"),j.notify("Setting up the export"),b.generateExportConfiguration(a).then(function(b){var g=b.s3UploadIdentifier;c.save(JSON.stringify(p),b,{isPrivate:!0}).then(function(){var h=d.timer(f,k+":polling-completed"),n=d.timer(f,k+":polling-timeout"),o=d.timer(f,k+":polling-error"),p=function(){h.end(),d.log(f,k+" completed"),i(a,b.signedOutputUrl,e).then(function(a){j.resolve(a,g)},function(a){m(a,g)})};j.notify("Processing your export"),c.poll(b.signedErrorListUrl,{stoppedSemaphore:l,sleepPeriod:15e3}).then(function(){o.end(),m("generation-error",g)}),c.poll(b.signedOutputListUrl,{stoppedSemaphore:l,sleepPeriod:2500}).then(p,function(a){n.end(),m(a,g)})},m,n)},m),j.promise())}},jQuery.fn.layoutExportWidget=function(a){"use strict";return this.each(function(){var b=jQuery(this),c=function(){var a=b.find("[data-mm-role=format-selector]");return a&&a.val()?a.val():b.data("mm-format")},d=b.find("[data-mm-role~=start-export]"),e=function(a){b.find(".visible").hide(),b.find(".visible."+a).show().find("[data-mm-show-focus]").focus(),b.trigger(jQuery.Event("stateChanged",{state:a}))},f=function(a){_.each(a,function(a,c){b.find("[data-mm-role~="+c+"]").each(function(){var b=jQuery(this);"A"===b.prop("tagName")?b.attr("href",a):"INPUT"===b.prop("tagName")||"TEXTAREA"===b.prop("tagName")?b.val(a).attr("data-mm-val",a):"DIV"===b.prop("tagName")&&(_.contains(b.attr("data-mm-role").split(" "),a)?b.show():b.hide())})}),e("done")},g=function(a){b.find("[data-mm-role=publish-progress-message]").text(a)},h=function(){var a=b.find("form[data-mm-role~=export-parameters]"),c={};return a&&a.find("button.active").add(a.find("select")).add(a.find("input")).each(function(){c[jQuery(this).attr("name")]=jQuery(this).val()||jQuery(this).attr("placeholder")}),c},i=function(a,d){b.find("[data-mm-role=contact-email]").attr("href",function(){return"mailto:"+jQuery(this).text()+"?subject=MindMup%20"+c().toUpperCase()+"%20Export%20Error%20"+d}),b.find("[data-mm-role=file-id]").html(d),b.find(".error span").hide(),e("error");var f=b.find("[data-mm-role="+a+"]");f.length>0?f.show():b.find("[data-mm-role=error-message]").html(a).show()},j=function(){e("inprogress"),a.startExport(c(),{"export":h()}).then(f,i,g)};b.find("form").submit(function(){return!1}),d.click(j).keydown("space",j),b.modal({keyboard:!0,show:!1,backdrop:"static"}),b.find("[data-mm-role=set-state]").click(function(){e(jQuery(this).attr("data-mm-state"))}),b.on("show",function(a){this===a.target&&e("initial")})})},MM.buildMapLayoutExporter=function(a,b){"use strict";return function(){var c=a.getCurrentLayout();return c&&c.nodes&&_.each(c.nodes,function(a){a.attr&&a.attr.icon&&a.attr.icon.url&&(a.attr.icon.url=b(a.attr.icon.url))}),c}},MM.ajaxResultProcessor=function(a){"use strict";var b=jQuery.Deferred();return jQuery.ajax({url:a["output-url"],dataType:"json"}).then(function(c){b.resolve(_.extend({},a,c))},function(){b.reject("generation-error")}),b.promise()},MM.layoutExportDecorators={},MM.layoutExportDecorators.twitterIntentResultDecorator=function(a){"use strict";a["twitter-url"]="https://twitter.com/intent/tweet?text="+encodeURIComponent(a["export"].title)+"&url="+encodeURIComponent(a["index-html"])+"&source=mindmup.com&related=mindmup&via=mindmup"},MM.layoutExportDecorators.facebookResultDecorator=function(a){"use strict";a["facebook-url"]="https://www.facebook.com/dialog/share_open_graph?app_id=621299297886954&display=popup&action_type=og.likes&action_properties=%7B%22object%22%3A%22"+encodeURIComponent(a["index-html"])+"%22%7D&redirect_uri="+encodeURIComponent("http://www.mindmup.com/fb")},MM.layoutExportDecorators.googlePlusResultDecorator=function(a){"use strict";a["google-plus-url"]="https://plus.google.com/share?url="+encodeURIComponent(a["index-html"])},MM.layoutExportDecorators.linkedinResultDecorator=function(a){"use strict";a["linkedin-url"]="http://www.linkedin.com/shareArticle?mini=true&url="+encodeURIComponent(a["index-html"])+"&title="+encodeURIComponent(a["export"].title)+"&summary="+encodeURIComponent(a["export"].description)+"&source=MindMup"},MM.layoutExportDecorators.tumblrResultDecorator=function(a){"use strict";a["tumblr-url"]="http://www.tumblr.com/share/link?url="+encodeURIComponent(a["index-html"])+"&name="+encodeURIComponent(a["export"].title)+"&description="+encodeURIComponent(a["export"].description)},MM.layoutExportDecorators.pinterestResultDecorator=function(a){"use strict";a["pinterest-url"]="https://pinterest.com/pin/create/button/?media="+encodeURIComponent(a["thumb-png"])+"&url="+encodeURIComponent(a["index-html"])+"&is_video=false&description="+encodeURIComponent(a["export"].description)},MM.layoutExportDecorators.embedResultDecorator=function(a){"use strict";a["embed-markup"]='<iframe src="'+a["index-html"]+'"></iframe>'},MM.layoutExportDecorators.gmailResultDecorator=function(a){"use strict";a["gmail-index-html"]="https://mail.google.com/mail/u/0/?view=cm&ui=2&cmid=0&fs=1&tf=1&body="+encodeURIComponent(a["export"].title+"\n\n")+encodeURIComponent(a["index-html"])},MM.layoutExportDecorators.emailResultDecorator=function(a){"use strict";a["email-index-html"]="mailto:?subject="+encodeURIComponent(a["export"].title)+"&body="+encodeURIComponent(a["export"].description+":\r\n\r\n")+encodeURIComponent(a["index-html"])},MM.layoutExportDecorators.gmailZipResultDecorator=function(a){"use strict";a["gmail-archive-zip"]="https://mail.google.com/mail/u/0/?view=cm&ui=2&cmid=0&fs=1&tf=1&body="+encodeURIComponent(a["export"].title+"\n\n")+encodeURIComponent(a["archive-zip"])},MM.layoutExportDecorators.emailZipResultDecorator=function(a){"use strict";a["email-archive-zip"]="mailto:?subject="+encodeURIComponent(a["export"].title)+"&body="+encodeURIComponent(a["export"].description+":\r\n\r\n")+encodeURIComponent(a["archive-zip"])},MM.sendExportDecorators={},MM.sendExportDecorators.emailOutputUrlDecorator=function(a){"use strict";a["email-output-url"]="mailto:?&body="+encodeURIComponent(a["output-url"]+"\n\nThe link will be valid for 24 hours")},MM.sendExportDecorators.gmailOutputUrlResultDecorator=function(a){"use strict";a["gmail-output-url"]="https://mail.google.com/mail/u/0/?view=cm&ui=2&cmid=0&fs=1&tf=1&body="+encodeURIComponent(a["output-url"]+"\n\n the link will be valid for 24 hours")},MM.buildDecoratedResultProcessor=function(a,b){"use strict";return function(c){var d=jQuery.Deferred();return a(c).then(function(a){_.each(b,function(b){b(a)}),d.resolve(a)},d.reject),d.promise()}},MM.S3Api=function(){"use strict";var a=this;this.save=function(a,b,c){var d=new FormData,e=c&&c.isPrivate?"bucket-owner-read":"public-read",f=jQuery.Deferred(),g=function(a){a.lengthComputable?f.notify(Math.round(100*a.loaded/a.total,2)+"%"):f.notify()},h=function(a){var b,c,d,e={EntityTooLarge:"file-too-large"};if(403===a.status)return void f.reject("failed-authentication");try{b=a&&(a.responseXML||jQuery.parseXML(a.responseText)),c=jQuery(b).find("Error Code").text()}catch(g){}return c?(d=jQuery(b).find("Error Message").text(),void f.reject(e[c],d)):void f.reject("network-error")};return["key","AWSAccessKeyId","policy","signature"].forEach(function(a){d.append(a,b[a])}),d.append("acl",e),d.append("Content-Type",b["Content-Type"]||"text/plain"),d.append("file",a),jQuery.ajax({url:"https://"+b.s3BucketName+".s3.amazonaws.com/",type:"POST",processData:!1,contentType:!1,data:d,xhr:function(){var a=new XMLHttpRequest;return a.upload.addEventListener("progress",g),a}}).then(f.resolve,h,g),f.promise()},a.pollerDefaults={sleepPeriod:1e3,timeoutPeriod:12e4},a.poll=function(b,c){var d,e,f=jQuery.Deferred(),g=function(){return f&&!(c.stoppedSemaphore&&c.stoppedSemaphore())},h=function(){var a=function(){g()&&(c.sleepTimeoutId=window.setTimeout(h,c.sleepPeriod))};g()?jQuery.ajax({url:b,timeout:c.sleepPeriod,method:"GET"}).then(function(b){var c=jQuery(b).find("Contents Key").first().text();f&&c?(window.clearTimeout(e),f.resolve(c)):a()},a):window.clearTimeout(e)},i=function(){g()&&f.reject("polling-timeout"),window.clearTimeout(d),f=void 0};return c=_.extend({},a.pollerDefaults,c),g()&&(e=window.setTimeout(i,c.timeoutPeriod),h()),f.promise()},a.loadUrl=function(a){var b=jQuery.Deferred();return jQuery.ajax(a,{cache:!1}).then(b.resolve,function(a){b.reject(404===a.status||403===a.status?"map-not-found":"network-error")}),b.promise()}},MM.LocalStorageClipboard=function(a,b,c,d){"use strict";var e=this,f=function(a){return JSON.parse(JSON.stringify(a))},g=function(a,b){var c;return a?_.isArray(a)?_.map(a,function(a){return g(a,b)}):(c=f(a),a.attr&&a.attr.icon&&a.attr.icon.url&&(c.attr.icon.url=b(a.attr.icon.url)),a.ideas&&(c.ideas={},_.each(a.ideas,function(a,d){c.ideas[d]=g(a,b)})),c):a};e.get=function(c){return c?a.getItem(b):g(a.getItem(b),d.storeResource)},e.put=function(e){try{a.setItem(b,g(e,d.getResource))}catch(f){c.show("Clipboard error","Insufficient space to copy object - saving the map might help up free up space","error")}}},jQuery.fn.newFromClipboardWidget=function(a,b,c){"use strict";var d=jQuery(this);return d.click(function(){var d,e=a.get(!0);e&&(_.isArray(e)&&e.length>1?(d=MAPJS.content(JSON.parse(JSON.stringify(MM.Maps["default"]))),d.pasteMultiple(1,e)):(_.isArray(e)&&(e=e[0]),e.attr&&e.attr.style&&(e.attr.style=void 0),d=MAPJS.content(e)),c.compress(d),b.setMap(d))}),d},MM.IOS.Alert=function(a){"use strict";var b=this,c=1;b.show=function(b,d,e){var f=c;return c+=1,a.sendMessage({type:"alert:show",args:{message:b,detail:d,type:e,currentId:f}}),f},b.hide=function(b){a.sendMessage({type:"alert:hide",args:{messageId:b}})}},MM.IOS.AutoSave=function(a,b){"use strict";var c=this,d=!1;a.addEventListener("unsavedChangesAvailable",function(){return d?void a.discardUnsavedChanges():void b.requestConfirmation("You have unsaved changes",{"default":"Apply unsaved changes",destructive:"Discard unsaved changes"},"You have made changes to this map that were not saved. Please choose if you would like to apply them or discard them and continue with the saved version").then(function(b){"default"===b?a.applyUnsavedChanges():a.discardUnsavedChanges()})}),c.on=function(){d=!1},c.off=function(){d=!0}},MM.IOS.ConfirmationProxy=function(a){"use strict";var b,c,d=this,e=1,f=["default","cancel","destructive"];d.requestConfirmation=function(d,g,h){var i=jQuery.Deferred(),j={title:d,confirmationId:e},k={};return d&&d.trim()?(_.each(f,function(a){var b=g[a];b&&(k[a]=b)}),_.isEmpty(k)?i.reject("invalid-args").promise():(h&&h.trim()&&(j.message=h),_.extend(j,k),a.sendMessage({type:"confirmation:show",args:j}),e++,b=i,c=j.confirmationId,i.promise())):i.reject("invalid-args").promise()},d.handlesCommand=function(a){return a&&"confirmation:choice"===a.type&&c===a.args[0]&&_.contains(f,a.args[1])?!0:!1},d.handleCommand=function(a){return d.handlesCommand(a)?(b.resolve(a.args[1]),!0):!1}},jQuery.fn.iosContextMenuWidget=function(a,b){"use strict";return jQuery(this).each(function(){var c=jQuery(this),d=c.find('[data-mm-role~="context-menu-toolbar"]'),e=c.find('[data-mm-role~="context-menu-tool-container"]');d.click(function(a){a.preventDefault(),a.stopPropagation()}),b&&b.each(function(){jQuery(this).clone(!0).css("display","").appendTo(e).click(function(){c.trigger(jQuery.Event("hidePopover"))})}),a.addEventListener("contextMenuRequested",function(b,d,e){(!a.getEditingEnabled||a.getEditingEnabled())&&c.trigger(jQuery.Event("showPopover",{x:d,y:e}))})})},MM.IOS.ExportRequestHandler=function(a,b,c,d,e){"use strict";var f=observable(this),g=MM.buildDecoratedResultProcessor(MM.ajaxResultProcessor,MM.layoutExportDecorators),h={
"publish.json":{exporter:c.getActiveContent,processor:g}},i=function(){return new MM.LayoutExportController(h,a.goldApi,a.s3Api,b)},j=i();e=e||"ios-export-result",f.handlesCommand=function(a){return a&&a.type&&"exportRequest"==a.type},f.handleCommand=function(a){var b=a&&a.args&&a.args[0];b&&f.dispatchEvent("exportRequest",b,function(a){var b=a.find('[data-mm-role~="'+e+'"]');a.iosModalWidget(d),a.layoutExportWidget(j),a.atlasPrepopulationWidget(c,40,150),a.find('[data-mm-role~="ios-send-export"]').iosExportResultSendWidget(d,b)})},a.addEventListener("serverConnectorChanged",function(){j=i()})},MM.layoutExportDecorators.iosResultDecorator=function(a){"use strict";var b={"thumb-png":a["thumb-png"],"index-html":a["index-html"],"archive-zip":a["archive-zip"],"export":a["export"]};a["ios-export-result"]=JSON.stringify(b)},jQuery.fn.iosExportResultSendWidget=function(a,b){"use strict";return jQuery(this).each(function(){var c=jQuery(this);c.click(function(){var d=b&&b.size&&b.size()>0&&b.val(),e=c&&d&&""!==d&&c.data("mm-method"),f=e&&d&&JSON.parse(d);f&&(f.sendMethod=e,a.sendMessage({type:"sendExportResult",args:f}))})})},MM.IOS.LicenseCommandHandler=function(a){"use strict";var b=this;b.handlesCommand=function(a){return a&&a.type&&"license:set"==a.type},b.handleCommand=function(b){var c=b&&b.args&&b.args[0];c?a.storeLicense(c):a.removeLicense()}},jQuery.fn.iosLinkEditWidget=function(a){"use strict";return jQuery(this).each(function(){var b=jQuery(this);a.addEventListener("linkSelected",function(a,c,d){b.find('[data-mm-role~="link-removal"]').data("mm-model-args",[a.ideaIdFrom,a.ideaIdTo]),b.find('[data-mm-role~="link-color"]').data("mm-model-args",[a.ideaIdFrom,a.ideaIdTo,"color"]),d&&d.arrow?(b.find('[data-mm-role~="link-no-arrow"]').show().data("mm-model-args",[a.ideaIdFrom,a.ideaIdTo,"arrow",!1]),b.find('[data-mm-role~="link-arrow"]').hide()):(b.find('[data-mm-role~="link-no-arrow"]').hide(),b.find('[data-mm-role~="link-arrow"]').show().data("mm-model-args",[a.ideaIdFrom,a.ideaIdTo,"arrow",!0])),d&&d.lineStyle&&"dashed"===d.lineStyle?(b.find('[data-mm-role~="link-solid"]').show().data("mm-model-args",[a.ideaIdFrom,a.ideaIdTo,"lineStyle","solid"]),b.find('[data-mm-role~="link-dashed"]').hide()):(b.find('[data-mm-role~="link-dashed"]').show().data("mm-model-args",[a.ideaIdFrom,a.ideaIdTo,"lineStyle","dashed"]),b.find('[data-mm-role~="link-solid"]').hide()),b.trigger(jQuery.Event("showPopover",c))})})},MM.IOS.MapLoadHandler=function(a,b,c,d,e,f,g,h,i,j){"use strict";var k=this;k.handlesCommand=function(a){return"loadMap"===a.type?!0:!1},k.handleCommand=function(l){if(k.handlesCommand){var m=l.args[0],n=l.args[1],o=l.args[2],p=MAPJS.content(m),q=l.args[3]||"ios-no-autosave",r=!0,s=jQuery("#splittable");"ios-no-autosave"===q||n?a.off():a.on(),b.inlineEditingDisabled=o,c.sendMessage({type:"map-save-option",args:{dialog:"not-required"}}),p.addEventListener("changed",function(){c.sendMessage({type:"map-save-option",args:{dialog:"show"}})}),d.setIdea(p),e.domMapWidget(f,g,r,h,s,i.getResource,!0,b),j.loadMap(q),n?(jQuery('[data-mm-role="ios-menu"]').remove(),g.setEditingEnabled(!1)):g.setEditingEnabled(!0),o?(jQuery("body").addClass("ios-quick-edit-on"),jQuery("body").removeClass("ios-quick-edit-off")):(jQuery("body").removeClass("ios-quick-edit-on"),jQuery("body").addClass("ios-quick-edit-off"))}}},MM.IOSMapSource=function(a){"use strict";var b={editable:!0},c=a;this.recognises=function(){return!0},this.setIdea=function(a){c=a},this.loadMap=function(a){return jQuery.Deferred().resolve(c,a,b).promise()}},MM.IOS.MapModelProxy=function(a,b,c,d){"use strict";var e=this;e.handlesCommand=function(b){if(b&&b.type&&b.type.substr&&"mapModel:"===b.type.substr(0,9)){var c=e.mapModelCommandName(b);if(a[c])return c}return!1},e.mapModelCommandName=function(a){var b=a&&a.type&&a.type.split&&a.type.split(":");return b&&2===b.length?b[1]:!1},e.handleCommand=function(b){var d,f;return"mapModel:setIcon"===b.type?(d=b.args&&b.args[0],d?a.setIcon("icon-editor",c.storeResource(d.url),d.width,d.height,d.position):a.setIcon(!1)):(f=e.handlesCommand(b),f?a[f].apply(a,b.args):!1)},a.addEventListener("nodeEditRequested",function(c,e,f){if(d&&d.inlineEditingDisabled){var g=a.findIdeaById(c),h=g&&g.title;b.sendMessage({type:"nodeEditRequested",args:{nodeId:c,title:h,shouldSelectAll:e,editingNew:f}})}})},jQuery.fn.iosMenuWidget=function(a,b){"use strict";return jQuery(this).each(function(){var c=jQuery(this),d=c.data("mm-default-menu"),e=c.find('[data-mm-role="ios-toolbar"]'),f=c.find('[data-mm-role="ios-menu-title"]'),g=c.data("mm-source")||"ios",h=f.text(),i=f.data("mm-toggled-text"),j=[],k=function(a,b){c.find('[data-mm-menu][data-mm-menu!="'+a+'"]').hide(),c.find('[data-mm-menu="'+a+'"]').show(),b&&j.push(a),f.text(0===j.length?i:"Back")},l=function(){j.pop(),k(j.length>0?j[j.length-1]:d)};c.find('[data-mm-menu][data-mm-menu!="'+d+'"]').hide(),c.find('[data-mm-role="ios-menu-toggle"]').click(function(){e.is(":visible")?j.length>0?l():(e.hide(),f.text(h)):(f.text(i),e.show())}),c.find('[data-mm-menu-role~="showMenu"]').click(function(){var a=jQuery(this),b=a.data("mm-action");b&&k(b,!0)}),c.find('[data-mm-menu-role~="modelAction"]').click(function(){var b=jQuery(this),c=b.data("mm-action"),d=b.data("mm-model-args")||[],e=[g].concat(d);c&&a&&a[c]&&a[c].apply(a,e)}),c.find('[data-mm-menu-role~="showModal"]').click(function(){var a=jQuery(this),b=a.data("mm-widget-role"),c=jQuery('[data-mm-role~="'+b+'"]');c.data("mm-model-args",a.data("mm-model-args")),c.showModal()}),c.find('[data-mm-menu-role~="showWidget"]').click(function(){var a=jQuery(this),b=a.data("mm-widget-role"),c=jQuery('[data-mm-role~="'+b+'"]');c.data("mm-model-args",a.data("mm-model-args")),c.show()}),c.find('[data-mm-menu-role~="sendMessage"]').click(function(){var a=jQuery(this),c={type:a.data("mm-message-type")},d=a.data("mm-message-args");d&&(c.args=d.split(",")),b.sendMessage(c)})})},jQuery.fn.iosModalExportWidget=function(a){"use strict";return this.each(function(){var b=jQuery(this),c=b.parent(),d=b.data("mm-format"),e=function(a,e){if(a===d){var f=b.clone();f.appendTo(c),e(f),f.showModal(),f.on("hidden",function(){f.remove()})}};b.detach(),a.addEventListener("exportRequest",e)})},MM.IOS.ModalRequestHandler=function(a){"use strict";var b=this;b.handlesCommand=function(a){return a&&a.type&&"modal"==a.type},b.handleCommand=function(b){var c=b&&b.args&&b.args[0],d=jQuery('[data-mm-role~="'+a+'"]');"hide"===c?d.hideModal():jQuery('[data-mm-ios-role="'+c+'"]').click()}},jQuery.fn.iosModalWidget=function(a){"use strict";return jQuery(this).each(function(){var b=jQuery(this);b.hide(),b.find('[data-mm-role~="dismiss-modal"]').click(function(){b.hideModal()}),b.on("shown",function(){a.sendMessage({type:"modal",args:["shown"]})}),b.on("hidden",function(){a.sendMessage({type:"modal",args:["hidden"]})}),b.on("stateChanged",function(c){var d=b.find('[data-mm-role="ios-modal-tools"]'),e=d.find(".visible."+c.state),f=["stateChanged",c.state];e.each(function(a,b){var c=jQuery(b).data("mm-ios-role");c&&f.push(c)}),a.sendMessage({type:"modal",args:f})})})},jQuery.fn.showModal=function(){"use strict";return jQuery(this).each(function(){var a=jQuery(this),b=!a.is(":visible");b&&a.trigger(jQuery.Event("show")),a.show(),b&&a.trigger(jQuery.Event("shown"))})},jQuery.fn.hideModal=function(){"use strict";return jQuery(this).each(function(){var a=jQuery(this),b=a.is(":visible");b&&a.trigger(jQuery.Event("hide")),a.hide(),b&&a.trigger(jQuery.Event("hidden"))})},jQuery.fn.iosModeIndicatorWidget=function(a){"use strict";return jQuery(this).each(function(){var b=jQuery(this);a.addEventListener("addLinkModeToggled",function(a){b.find('[data-mm-role="modeIndicator"]').hide(),a?(b.show(),b.find('[data-mm-mode="addLinkMode"]').show()):b.hide()})})},jQuery.fn.iosBackgroundColorWidget=function(a,b,c){"use strict";return jQuery(this).each(function(){var d=jQuery(this),e=d.find('[data-mm-role="ios-color-palette"]'),f=d.find('[data-mm-role="ios-color-selector-template"]').detach(),g=d.find('[data-mm-role="ios-modal-content"]'),h=d.data("mm-model-method")||"updateStyle";c=c||"ios",d.on("hide",function(){return g.scrollTop(0),!0}),_.each(b,function(b){var g=f.clone(),i="transparent"===b?"":"#"+b,j=d.find('[data-mm-role="transparent-color-image"]').attr("src");"transparent"===b&&g.css({"background-image":"url("+j+")","background-size":"100% 100%"}),g.css("background-color",i),g.appendTo(e).show().click(function(){var b=d.data("mm-model-args")||["background"];a[h].apply(a,[c].concat(b).concat(i)),d.hideModal()})})})},jQuery.fn.iosPopoverMenuWidget=function(a,b){"use strict";return jQuery(this).each(function(){var c=jQuery(this),d=c.find('[data-mm-role~="popover-toolbar"]'),e=c.find('[data-mm-role="popover-pointer-top"]'),f=c.find('[data-mm-role="popover-pointer-bottom"]'),g=function(){c.is(":visible")&&(c.unbind("click"),c.hide())},h=function(){g()},i=function(a){(a||c.is(":visible"))&&c.click(h)},j=function(){return c.height()-d.outerHeight()+20},k=function(b){var g=b.x,h=b.y,k=j(),m=h>k,n=c.width()-d.outerWidth()-10,o=10,p=Math.max(o,Math.min(n,g-d.outerWidth()/2)),q=m?h-d.outerHeight()-10:h+10,r=20,s=d.outerWidth()-20,t=Math.max(r,Math.min(s,g-p-10)),u=a&&a.getCurrentlySelectedIdeaId();u&&l(u),m?(f.css("left",t+"px"),e.hide(),f.show()):(e.show(),f.hide(),e.css("left",t+"px")),d.css({top:Math.max(-20,q)+"px",left:p+"px"}),b.noDelay?i(!0):window.setTimeout(i,1e3),c.show()},l=function(b){var d=a.contextForNode(b);_.each(d,function(a,b){var d=c.find("[data-mm-menu-role~=ios-node-context-"+b+"]");a?d.removeClass("iosDisabled"):d.addClass("iosDisabled")})};d.click(function(a){a.preventDefault(),a.stopPropagation()}),c.find('[data-mm-role~="popover-close"]').click(g),c.on("hidePopover",function(){g()}),c.on("showPopover",k),b&&(b.topBottomHeight=j(),b.addEventListener("togglePopover",function(a){c.is(":visible")?g():k(_.extend({},a,{noDelay:!0}))}))})},MM.IOS.ServerConfig=function(a,b){"use strict";var c=observable(this);c.handlesCommand=function(a){return a&&a.type&&"config:set"===a.type},c.handleCommand=function(b){var d=b&&b.args&&b.args[0],e=a.getItem("ios-config");d||(d=void 0),_.isEqual(d,e)||(a.setItem("ios-config",d),c.dispatchEvent(b.type,d))},c.valueForKey=function(c){var d=a.getItem("ios-config"),e=d&&d[c];return e?e:b?b[c]:void 0}},MM.IOS.ServerConnector=function(a,b,c){"use strict";var d=observable(this),e=function(){d.goldApi=new MM.GoldApi(a,b.valueForKey("goldApiUrl"),c,b.valueForKey("goldBucketName"))};e(),b.addEventListener("config:set",function(){e(),d.dispatchEvent("serverConnectorChanged")}),d.s3Api=new MM.S3Api},MM.IOSStageAPI=function(a){"use strict";var b=observable(this);b.togglePopoverMenu=function(){a.dispatchEvent("nodeVisibilityRequested");var c=jQuery(".mapjs-node.selected"),d=c&&b.getRectForNode(c),e=d&&b.getTouchPointForRect(d);e&&(c[0].scrollIntoViewIfNeeded(),b.dispatchEvent("togglePopover",e,!0))},b.getRectForNode=function(a){var b=jQuery("[data-mapjs-role=stage]"),c=b&&b.data&&b.data("scale"),d=a&&a.offset&&a.offset(),e=a&&a.outerWidth&&a.outerWidth(),f=a&&a.outerHeight&&a.outerHeight();return b&&c&&d&&e&&f?{left:d.left,top:d.top,width:e*c,height:f*c}:!1},b.getTouchPointForRect=function(a){var b=jQuery("body"),c=b&&b.innerWidth(),d=b&&b.innerHeight(),e=d&&a&&Math.min(d,Math.max(0,a.top+a.height/2)),f=c&&a&&Math.min(c,Math.max(0,a.left+a.width/2));return e&&f?{x:f,y:e}:!1},b.handlesCommand=function(a){return a.type&&a.type.substr&&"iosStage:"===a.type.substr(0,9)?!0:!1},b.handleCommand=function(a){if(b.handlesCommand(a)){var c=a.type.split(":")[1];c&&b[c]&&b[c].apply(b,a.args)}}},MM.IOS.WindowProxy=function(a,b,c){"use strict";var d=this,e=100,f=function(){a&&a.centerOnNode&&a.getSelectedNodeId()&&a.centerOnNode(a.getSelectedNodeId())},g=function(a){if("setViewport"!==a.type)return!1;var b=jQuery("meta[name=viewport]").attr("content");return b!==a.args&&(jQuery("meta[name=viewport]").attr("content",a.args),jQuery('[data-mm-role="ios-context-menu"]').add(jQuery('[data-mm-role="ios-link-editor"]')).trigger(jQuery.Event("hidePopover")),window.setTimeout(f,e)),!0},h=function(d){return"prepareForSave"!==d.type?!1:(a.resetView(),jQuery('[data-mm-role="ios-menu"]').hide(),jQuery('[data-mm-role="ios-toolbar"]').hide(),jQuery('[data-mm-role="ios-context-menu"]').trigger(jQuery.Event("hidePopover")),jQuery('[data-mm-role="ios-link-editor"]').trigger(jQuery.Event("hidePopover")),window.setTimeout(function(){a.scaleDown(),window.setTimeout(function(){var e=a.getIdea(),f=e.title||"Mindmup map",g=d.args&&d.args[0]&&"save-screen-only"===d.args[0];g?b.sendMessage({type:"save-screen"}):(c.compress(e),b.sendMessage({type:"save-content",args:{title:f,idea:JSON.stringify(e)}}))},e)},e),!0)};d.handlesCommand=function(a){return"setViewport"===a.type||"prepareForSave"===a.type?!0:!1},d.handleCommand=function(a){return d.handlesCommand(a)?void(g(a)||h(a)):!1}},MM.IOS.defaultMap=function(){"use strict";return{title:"double-tap this node to edit",id:1,formatVersion:2}},MM.IOS.Proxy=function(a){"use strict";var b=this,c=window.webkit&&window.webkit.messageHandlers&&window.webkit.messageHandlers[a];b.sendMessage=c?function(){try{var a=Array.prototype.slice.call(arguments,0);if(!a||0===a.length)return;c.postMessage(a.length>1?JSON.parse(JSON.stringify(a)):JSON.parse(JSON.stringify(a[0])))}catch(b){}}:function(){console.log.apply(console,arguments)},c&&(window.console.log=function(){var a=Array.prototype.slice.call(arguments,0);b.sendMessage({type:"log",args:a})},window.onerror=function(){try{var a=Array.prototype.slice.call(arguments,0);b.sendMessage({type:"error",args:a})}catch(c){}return!1})},jQuery.fn.modal=function(a){"use strict";return jQuery(this).each(function(){var b=jQuery(this);a&&(a.show||"show"===a?b.showModal():b.hideModal())})},MAPJS.DOMRender=MAPJS.DOMRender||{},MAPJS.DOMRender.stageMargin={top:60,left:20,bottom:100,right:20},MAPJS.DOMRender.stageVisibilityMargin={top:20,left:20,bottom:20,right:20},MM.main=function(a){"use strict";console.log("MM.main");var b=new MM.IOS.Proxy("mmproxy"),c=new MM.ActivityLog(1e4),d=function(a,c,d){a.addEventListener("log",function(){var a=Array.prototype.slice.call(arguments,0,3);b.sendMessage({type:"analytic",args:a})}),a.addEventListener("error",function(c){var d=["error",c,a.getLog()];b.sendMessage({type:"analytic",args:d})}),a.addEventListener("timer",function(a,c,d){var e=[a,c,"",d];b.sendMessage({type:"analytic",args:e})}),d&&c.addEventListener("analytic",a.log),c.addEventListener("layoutChangeStarting",function(){var a=Array.prototype.slice.call(arguments,0);b.sendMessage({type:"layoutChangeStarting",args:a})}),c.addEventListener("layoutChangeComplete",function(){var a=Array.prototype.slice.call(arguments,0);b.sendMessage({type:"layoutChangeComplete",args:a})})},e=jQuery("#container"),f=new MM.IOSMapSource(MAPJS.content(MM.IOS.defaultMap())),g=new MM.MapController([f]),h=new MM.ActiveContentListener(g),i="internal",j=new MM.ResourceCompressor(i),k=new MM.ActiveContentResourceManager(h,i),l=new MAPJS.ImageInsertController(a.corsProxyUrl,k.storeResource),m=MM.IOS.Alert(b),n=new MM.JsonStorage(window.localStorage),o=new MM.LocalStorageClipboard(n,"clipboard",m,k),p=new MAPJS.MapModel(MAPJS.DOMRender.layoutCalculator,["double-tap this node to edit"],o),q=new MM.IOSStageAPI(p),r=new MM.iconEditor(p,k),s=_.extend({},a),t=new MM.IOS.MapModelProxy(p,b,k,s),u=new MM.IOS.ServerConfig(n,a),v=new MM.GoldLicenseManager(n,"licenseKey"),w=new MM.IOS.ConfirmationProxy(b),x=new MM.AutoSave(g,n,m,p),y=new MM.IOS.AutoSave(x,w),z=new MM.IOS.WindowProxy(p,b,j),A=new MM.IOS.MapLoadHandler(y,s,b,f,e,c,p,l,k,g),B=new MM.IOS.LicenseCommandHandler(v),C=new MM.IOS.ServerConnector(v,u,c),D=new MM.IOS.ExportRequestHandler(C,c,h,b),E=new MM.IOS.ModalRequestHandler("ios-modal"),F=[t,w,z,q,A,u,B,D,E],G=!1;g.addEventListener("mapLoaded",function(c,d){d.setConfiguration(a.activeContentConfiguration),p.setIdea(d),b.sendMessage({type:"mapLoaded"})}),r.addEventListener("iconEditRequested",function(a){b.sendMessage({type:"showMessage",args:{type:"info",message:"Loading icon editor, please wait..."}}),a=a||{},b.sendMessage({type:"iconEditRequested",args:a})}),d(c,p,G),MM.MapController.activityTracking(g,c),jQuery('[data-mm-role~="ios-modal"]').iosModalWidget(b),jQuery('[data-mm-role~="ios-menu"]').iosMenuWidget(p,b),jQuery('[data-mm-role="ios-context-menu"]').iosPopoverMenuWidget(p,q).iosContextMenuWidget(p,jQuery('[data-mm-menu-role~="context-menu"]')),jQuery('[data-mm-role="ios-link-editor"]').iosPopoverMenuWidget().iosMenuWidget(p,b).iosLinkEditWidget(p),jQuery('[data-mm-role="mode-indicator"]').iosModeIndicatorWidget(p),jQuery('[data-mm-role~="ios-color-picker"]').iosBackgroundColorWidget(p,["000000","993300","333300","000080","333399","333333","800000","FF6600","808000","008000","008080","0000FF","666699","808080","FF0000","FF9900","99CC00","339966","33CCCC","3366FF","800080","999999","FF00FF","FFCC00","FFFF00","00FF00","00FFFF","00CCFF","993366","C0C0C0","FF99CC","FFCC99","FFFF99","CCFFFF","FFFFFF","transparent"]),jQuery('[data-mm-role~="layout-export"]').iosModalExportWidget(D),MM.command=MM.command||function(a){var c={completed:!0,command:a.type},d=_.find(F,function(b){return b.handlesCommand(a)});return d?(d.handleCommand(a),c):("ping"===a.type?b.sendMessage(a):"contentSaved"===a.type?x.discardUnsavedChanges():"keyboardShown"===a.type?jQuery("body").addClass("ios-keyboardShown"):"keyboardHidden"===a.type?jQuery("body").removeClass("ios-keyboardShown"):"mapModel"===a.type&&a.args&&a.args.length>0&&p[a.args[0]].apply(p,a.args.slice(1)),c)},b.sendMessage({type:"loadComplete"})};
//# sourceMappingURL=mm-ios-compiled-4.min.js.map